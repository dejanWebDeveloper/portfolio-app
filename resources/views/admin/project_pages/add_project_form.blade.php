            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="store-project" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="select-category" class="form-control" name="category_id">
                                                <option></option>
                                                @foreach($addProjectContent['categories'] as $category)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="github_link" type="text"
                                                   ...
                                                   placeholder="Enter Github_link" value="{{old('github_link')}}">
                                            <div>
                                                @error('github_link')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="demo_link" type="text"
                                                   ...
                                                   placeholder="Enter Demo_link" value="{{old('demo_link')}}">
                                            <div>
                                                @error('demo_link')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('tags') is-invalid @enderror"
                                                    ...
                                                    id="select-tags"
                                                    multiple>
                                                @foreach($addProjectContent['tags'] as $tag)
                                                    <option value="{{ $tag->id }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text"
                                                      ...
                                                      name="text" id="project-text">{{old('text')}}</textarea>
                                            <div>
                                                @error('text')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
