<header class="fixed top-0 left-0 w-full bg-gray-950/80 backdrop-blur-md border-b border-gray-800 z-50">
    <nav class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <ul class="flex gap-6 text-gray-300">
            <li><a href="{{route('blog_page')}}" class="text-indigo-400 border-b-2 border-indigo-400 pb-1 font-medium">Projects</a></li>
            <li><a href="{{route('links_page')}}" class="hover:text-indigo-400 transition">Links</a></li>
